...
class MoviesViewTest(TestCase):
    def setUp(self):
        movie_1 = Movie.objects.create(title="Lord of the Rings", category="Fantasy", rating=8.0)
        movie_2 = Movie.objects.create(title="Matrix", category="Sci-Fi", rating=8.0)
        movie_3 = Movie.objects.create(title="Narnia", category="Fantasy", rating=6.0)
        movie_1.save()
        movie_2.save()
        movie_3.save()
